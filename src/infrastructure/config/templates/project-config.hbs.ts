export default `\
# security-scan — project configuration
# Generated by: security-scan init
#
...
scanners:
  sonarqube:
    ...
    #       Run "security-scan init" (with SonarQube enabled) to generate a template if missing.
...
#   branch_prefix: 'fix/security-scan-'   # prefix for the generated branch name
...
#   folder_id: 'YOUR_GOOGLE_DRIVE_FOLDER_ID'   # set automatically by 'security-scan cloud-setup'
#
# To connect Google Drive, run: security-scan cloud-setup
# Required environment variables (OAuth 2.0 Desktop app credentials from GCP Console):
#   SECURITY_SCAN_GOOGLE_CLIENT_ID=<your-oauth2-client-id>
#   SECURITY_SCAN_GOOGLE_CLIENT_SECRET=<your-oauth2-client-secret>
# Tokens are stored in: ~/.config/security-scan/tokens.json (chmod 600)
`;
