 ...
 *
 * Hardcoded to 'deep-health'. No whitelabel support.
 */

/** The CLI binary name. */
export const CLI_NAME = 'deep-health';
 ...
 * 'DEEP_HEALTH_NO_AUTO_FIX'
 */
export const KILL_SWITCH_VAR = 'DEEP_HEALTH_NO_AUTO_FIX';
